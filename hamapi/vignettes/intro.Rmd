...
Plese "uncomment" the 108, 109, 113 and 120 lines below. Because this function automatically download pictures and need a valid token. I commented it. It should work.
```{r}
#get_picture(
  #classification = 'Prints', 
...
#get_picture(size=5, numberp = 6, classification = 'Prints')
```
